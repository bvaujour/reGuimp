...
/*   Updated: 2026/01/12 17:33:25 by injah            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ui_slider_render(t_widget *slider)
{
	...
	SDL_RenderCopy(slider->renderer, data->slide_texture, NULL, &(SDL_Rect){slider->absolute.x + data->slide_position.x, slider->absolute.y, slider->absolute.w / data->slide_factor, slider->rect.h}); //render le slider curseur
}
